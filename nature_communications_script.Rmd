...
pingSubset[!is.na(posterior_hpc) & !is.na(anterior_hpc), summaryh(lm(TBX_ibam_scr ~ posterior_hpc  * Age_cat + GenderEC))]
...
pingSubset[!is.na(posterior_hpc) & !is.na(anterior_hpc), summaryh(lm(TBX_VOCAB_THETA ~ posterior_hpc  * Age_cat  + GenderEC))] #controlling for age
